//
//  CreateGroupPhotoController.swift
//  ProjectBuddies
//
...
protocol CreateGroupPhotoDelegate: class {
    func continueNextPage(controller: CreateGroupPhotoController)
}

class CreateGroupPhotoController: UIViewController {
    
    weak var delegate: CreateGroupPhotoDelegate?
...
extension CreateGroupPhotoController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
