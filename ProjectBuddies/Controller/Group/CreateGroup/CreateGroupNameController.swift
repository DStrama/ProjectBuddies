//
//  CreateGroupNameController.swift
//  ProjectBuddies
//
...
protocol CreateGroupNameDelegate: class {
    func continueNextPage(controller: CreateGroupNameController)
}

class CreateGroupNameController: UIViewController {
    
    // MARK: - Properties
    
    weak var delegate: CreateGroupNameDelegate?
...
extension CreateGroupNameController: UITextViewDelegate {
