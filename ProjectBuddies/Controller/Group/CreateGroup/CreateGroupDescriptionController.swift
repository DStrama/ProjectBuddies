//
//  CreateGroupDescriptionController.swift
//  ProjectBuddies
//
//  Created by Dominik Strama on 20/04/2021.
//

import UIKit

protocol CreateGroupDescriptionDelegate: class {
    func continueNextPage(controller: CreateGroupDescriptionController)
}

class CreateGroupDescriptionController: UIViewController {
    
    // MARK: - Properties
    
    weak var delegate: CreateGroupDescriptionDelegate?
    ...
    private func setUpViewsAndConstraints() {
        ...
        keyTextField.anchor(top: fistNameLabel.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 32, paddingLeft: 56, paddingRight: 56, height: 100)
...
extension CreateGroupDescriptionController: UITextViewDelegate {
