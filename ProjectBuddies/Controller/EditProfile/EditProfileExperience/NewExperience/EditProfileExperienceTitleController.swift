//
//  EditProfileExperienceTitleController.swift
//  ProjectBuddies
//
...
protocol EditProfileExperienceTitleDelegate: class {
    func continueNextPage(controller: EditProfileExperienceTitleController)
}

class EditProfileExperienceTitleController: UIViewController {
    
    // MARK: - Properties
    
    weak var delegate: EditProfileExperienceTitleDelegate?
    ...
    lazy var keyTextField: InputTextView = {
        ...
        tv.placeholderText = "Enter position name..."
...
extension EditProfileExperienceTitleController: UITextViewDelegate {
