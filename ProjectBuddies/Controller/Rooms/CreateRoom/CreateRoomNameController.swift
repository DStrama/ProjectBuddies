//
//  CreateRoomNameController.swift
//  ProjectBuddies
//
...
protocol CreateRoomNameDelegate: class {
    func continueNextPage(controller: CreateRoomNameController)
}

class CreateRoomNameController: UIViewController {
    
    // MARK: - Properties
    
    weak var delegate: CreateRoomNameDelegate?
...
extension CreateRoomNameController: UITextViewDelegate {
