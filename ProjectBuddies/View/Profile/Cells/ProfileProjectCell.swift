...
class ProfileProjectCell: UITableViewCell {
    ...
    private func setUpViewsAndConstraints( ) {
        ...
        titleLabel.anchor(top: container.topAnchor, left: container.leftAnchor, paddingTop: 16, paddingLeft: 16)

        container.addSubview(usedTechnologiesLabel)
        usedTechnologiesLabel.anchor(top: titleLabel.bottomAnchor, left: container.leftAnchor, right: container.rightAnchor, paddingTop: 2, paddingLeft: 16, paddingRight: 16)
        ...
        usedTechnologiesLabel.textAlignment = .justified
